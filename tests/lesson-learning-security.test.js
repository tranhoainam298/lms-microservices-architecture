...
const contentMigration = read('course-service/src/data/migrateLessonContent.js');
...
assert.match(contentMigration, /information_schema\.COLUMNS/i);
assert.match(contentMigration, /ALTER TABLE lessons ADD COLUMN content LONGTEXT NULL/i);
assert.doesNotMatch(contentMigration, /DROP|TRUNCATE|DELETE FROM/i);
assert.match(contentMigration, /MODIFY COLUMN content LONGTEXT NULL/);
...
assert.match(service, /lessonContent: lesson\.content \|\| ''/);
