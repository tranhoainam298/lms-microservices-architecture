// Inactive legacy sample data retained for compatibility.
...
export const mockCourses = [
  { id: 201, instructor_id: 2, title: "Foundations of Project Planning", description: "Learn how to define goals, organize tasks, and review project outcomes.", price: 99.00, status: "published", progress_percent: 33 },
...
export const mockLessons = [
  { id: 301, course_id: 201, title: "1.1 Defining clear objectives", content_url: "/video/1_1_objectives.mp4", lesson_order: 1 },
  { id: 302, course_id: 201, title: "1.2 Planning practical milestones", content_url: "/video/1_2_milestones.mp4", lesson_order: 2 },
  { id: 303, course_id: 201, title: "1.3 Reviewing project outcomes", content_url: "/video/1_3_review.mp4", lesson_order: 3 },
...
export const mockQuestionBank = [
  { id: 701, course_id: 201, question_text: "What should be defined before creating a project plan?", question_type: "single_choice", options: ["A clear objective", "A final invoice", "A completed report", "A certificate"], correct_answer: "A clear objective" },
  { id: 702, course_id: 201, question_text: "True or False: milestones help track progress.", question_type: "single_choice", options: ["True", "False"], correct_answer: "True" },
  { id: 703, course_id: 201, question_text: "Which activity helps improve future projects?", question_type: "single_choice", options: ["Reviewing outcomes", "Skipping feedback", "Removing goals", "Ignoring results"], correct_answer: "Reviewing outcomes" }
];

export const mockQuizzes = [
  { id: 801, course_id: 201, title: "Project Planning Basics", status: "published", due_label: "Due Friday at 17:00", question_count: 3 }
];
...
export const mockSubmittedAnswers = [
  { id: 1101, attempt_id: 1001, question_id: 701, submitted_answer: "A clear objective", is_correct: true },
...
export const mockExperienceFeedback = [
  {
    id: 1,
    quote: 'The course experience keeps every next step clear and easy to follow.',
    name: "Minh Anh Tran",
